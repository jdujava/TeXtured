...
\begin{remark}[MFF CUNI Template Compatibility]
    ...
    \end{itemize}
    Layout of these front matter pages is adapted and modified from the original MFF CUNI template \autocite{MaresTemplate}. However, always make sure it is compliant with the faculty guidelines, otherwise please raise an issue on GitHub \autocite{TeXtured}.
\end{remark}
