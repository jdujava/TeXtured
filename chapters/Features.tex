...
\begin{itemize}
    ...
    \item Deploy to \texttt{gh-pages} branch.
          ...
          \begin{Note}[Private Repositories]
              ...
              If you want to share the work more \enquote{privately}, there are other solutions, for example Github Action which uploads PDF to Google Drive, and sharing via private link.
          \end{Note}
\end{itemize}
