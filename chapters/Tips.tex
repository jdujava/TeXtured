...
\begin{table}[ht!]
    \begin{booktabs}{stretch=1.1}
        ...
        \fakeverb{\SI{123.45}{m/s^2}}             & \SI{123.45}{m/s^2}             & numbers with units \\
        \fakeverb{\SIrange{1}{10}{\kilo\meter}}   & \SIrange{1}{10}{\kilo\meter}   & ranges             \\
        \fakeverb{\SIlist{1;3;5}{A}}              & \SIlist{1;3;5}{A}              & lists              \\
        \fakeverb{\SI{1.23 +- 0.45}{\celsius}}    & \SI{1.23 +- 0.45}{\celsius}    & uncertainties      \\
        \bottomrule
    \end{booktabs}
...
\begin{Todo}
    ...
    When math macro is used often outside math mode (alone as ``\verb|... \(\foo\) ...|''), defining it wrapped in \verb|\ensuremath| can lead to perhaps easier use (as just ``\verb|... \foo{} ...|'').
\end{Todo}
\begin{Todo}
