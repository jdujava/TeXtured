...
\begin{example}[Multi-Paragraph Figure Caption with Verbatim Text]
    ...
    One must remember to provide a short description as \verb|\caption[Short Description]{...}|, otherwise \LaTeX{} will complain.
...
\begin{figure}[!ht]
    ...
    \caption[Necessary to provide short description.]{%
        ...
        Notice the spacing between the paragraphs, which was customized with the \fakeverb{\captionsetup} by specifying the \texttt{parskip} option.

        To typeset verbatim text in the caption, use the \fakeverb{\fakeverb{...}} command instead of the usual \fakeverb{\verb|...|}, which is not allowed in captions.
    }%
