...
\NewDocumentCommand{\iunit}{}{\mathring{\imath}}
\NewDocumentCommand{\eunit}{}{\mathinner{\mathrm{e}}}
\NewDocumentCommand{\eunits}{}{\mathrm{e}}
...
\NewDocumentCommand{\Sym}{}{S}
\NewDocumentCommand{\Symtrless}{}{\Sym_{\odot}}
...
\NewDocumentCommand{\rankgroup}{}{\ensuremath{\mathsf{r}}}
...
%% BUG: latex-grammar ERROR https://github.com/latex-lsp/tree-sitter-latex/issues/157
...
%% Modify position of superscript for \bigwedge
\NewDocumentCommand{\Ext}{e{^}}{
    \mathop{\bigwedge\nolimits\IfValueT{#1}{^{\mspace{-5mu}\raisebox{-0.13em}{\scriptsize\(#1\)}}}}
}
\NewDocumentCommand{\textExt}{m}{\text{\scalebox{.9}{\(\displaystyle\Ext#1\)}}}
...
%% square argument placeholder
\NewDocumentCommand{\argument}{s o}{
    \def\squaresize{0.4em}                 % default size
    \IfBooleanT{#1}{\def\squaresize{0.3em}} % if starred, set size corresponding to scriptstyle
    \IfValueT{#2}{\def\squaresize{#2}}      % if optional argument is passed, set size to custom value
    \mathcolor{Gray40}{\square[\squaresize][top][*(LightGrayFill)]}
}
