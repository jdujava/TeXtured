...
\titlecontents{chapter}[1.6em]{\vspace{2.4ex}\boldmath\bfseries} % <section> <left> <above-code>
...
\titlecontents*{subsection}[4.7em]{\footnotesize\color{black!70}}  % <section> <left> <above-code>
