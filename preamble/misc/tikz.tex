...
%% HACK: load `fadings` library before `\begin{document}`,
%% BUG:  otherwise it breaks the precompiled format file
\AddToHook{begindocument/before}{\usetikzlibrary{fadings}}
